...
![](https://github.com/flatiron-school/DS-Deloitte-07062022-AB-Testing-ML-Models-on-AWS/blob/main/images/iam-role-update-screen-1.png)
Click `Roles` in the nav pane on the left
<br>
<br>
![](https://github.com/flatiron-school/DS-Deloitte-07062022-AB-Testing-ML-Models-on-AWS/blob/main/images/iam-role-update-screen-2.png)
Click `AmazonSageMakerServiceCatalogProductsUseRole`
<br>
<br>
![](https://github.com/flatiron-school/DS-Deloitte-07062022-AB-Testing-ML-Models-on-AWS/blob/main/images/iam-role-update-screen-3.png)
Click on the associated policy name, as shown
<br>
<br>
![](https://github.com/flatiron-school/DS-Deloitte-07062022-AB-Testing-ML-Models-on-AWS/blob/main/images/iam-role-update-screen-3a.png)
Click the `+` icon to the left of the policy name, then click the `Edit` button
<br>
<br>
![](https://github.com/flatiron-school/DS-Deloitte-07062022-AB-Testing-ML-Models-on-AWS/blob/main/images/iam-role-update-screen-4.png)
Click the `JSON` tab
<br>
<br>
![](https://github.com/flatiron-school/DS-Deloitte-07062022-AB-Testing-ML-Models-on-AWS/blob/main/images/iam-role-update-screen-5.png)
Locate the `cloudwatch` actions, and add a comma after the one shown
<br>
<br>
![](https://github.com/flatiron-school/DS-Deloitte-07062022-AB-Testing-ML-Models-on-AWS/blob/main/images/iam-role-update-screen-6.png)
...
<br>
<br>
![](https://github.com/flatiron-school/DS-Deloitte-07062022-AB-Testing-ML-Models-on-AWS/blob/main/images/iam-role-update-screen-7.png)
